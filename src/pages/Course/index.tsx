      ...
      <div className="flex flex-col h-screen">
          ...
          <div className="flex flex-col space-y-6 p-5 lg:flex-row">
            ...
            <div className="w-full flex flex-col space-y-3 p-5 bg-white text-black rounded-lg h-fit">
              <div className="flex flex-col">
                ...
                <p className="text-xs">
                  Learn the fundamentals of physical preparation and take part
                  in the emergence of great athletes in Africa and around the
                  world.
                </p>
              ...
              <div>
                ...
                <div className="flex flex-col space-y-1">
                  <p className="text-xs ml-6">
                    Need an internet connection or a good computer device to
                    work with? No problem. You can check AWSP relay points here
                    at any time. We provide you with everything you need for a
        ...
        <div className="container mx-auto relative md:flex mt-6 justify-center items-center p-5 hidden ">
          <div className="h-[90%] w-full bg-[#D9D9D9] p-5 -z-10 flex flex-col space-y-3 rounded-md">
            ...
            <p className="text-xs">
              Add this qualification to your CV <br /> Share it on social
              networks
            </p>
          </div>
          <Image
